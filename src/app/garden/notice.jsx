  ...
  return (
    <div className="fixed bottom-4 left-4 flex flex-col gap-2 z-50">
      {notices.map((notice) => (
        <div
          key={notice.id}
          className="bg-red-100 border border-red-300 text-red-800 px-4 py-3 rounded-xl shadow-lg flex items-center gap-3 cursor-pointer hover:bg-red-200 transition"

  ...
  export async function GET() {
    try {
        ...
        for (const type of energyTypes) {
            ...
            const fetchDataResponse = await fetch(`${API_BASE_URL}/api/energy/fetchData/year/${type}`);
            ...
            const postResponse = await fetch(`${API_BASE_URL}/api/energy/fetchData/year/${type}`, {
                method: "POST",

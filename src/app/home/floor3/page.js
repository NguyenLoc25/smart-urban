...
export default function Floor3Page() {
  ...
  useEffect(() => {
    const bedroomLightRef = ref(db, 'floor3/bedroom_light');
    const acRef = ref(db, 'floor3/air_conditioner');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white p-6 md:p-10">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-purple-700 mb-4">Quản lý Tầng 3</h1>
        <p className="text-gray-700 mb-6">Giám sát và điều khiển các thiết bị ở tầng 3.</p>

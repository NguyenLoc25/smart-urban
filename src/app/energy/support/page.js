            ...
            <div className="bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/70 dark:border-gray-700/50">
              ...
              <ul className="space-y-3">
                {['Getting Started Guide', 'Troubleshooting', 'API Documentation', 'Video Tutorials'].map((item) => (
                  <li key={item} className="flex items-start gap-2 text-gray-700 dark:text-gray-300 hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors">
...
<div className="bg-gradient-to-br from-emerald-500 to-green-500 text-white p-5 rounded-2xl cursor-pointer hover:shadow-lg transition-all group">
